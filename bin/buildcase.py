...
def per_run_case_updates(case, date, restdir, user_mods_dir, rundir):
    ...
    case.set_value("PROJECT","CESM0021") # sglanvil 08feb2024
...
def _main_func(description):
    ...
    res = "f09_g17"
    if baseyear < 2014 or (baseyear == 2014 and basemonth < 11): # sglanvil, 2024-04-19, changed <12 to <11, because 45day forecasts
        compset = "BHIST"
    else:
        compset = "BSSP585"
    overwrite = True
