...
cd /glade/u/home/ssfcst/cesm2cam6climoOCNclimoLND/CESM2-Realtime-Forecast/ecflow
export ECF_PORT=35254
export ECF_HOST=derecho2
export CESM_WORKFLOW=cesm2cam6climoOCNclimoLND
...
while [ "$d" != 2022-09-05 ]; do # specify monday end date (the EXCLUDED monday)
	...
	python cesm2cam6climoOCNclimoLND_${year}_${month}_${day}/client.py
	echo	
	d=$(date -I -d "$d + 7 day")
done
